...
lambdas_rel = 5e-1; % logspace(-3,-0.3,100); %1e-2; %[1e-1 1e-2 1e-3]; % regularization (relative to lambda_max)
...
if CoD
    ...
    save(strcat('CasesTable_LogReg_CoD_',num2str(length(lambdas_rel)),'lambdas_seed',num2str(rng_seed)),"table_cases_CoD")    
end
...
if PG 
    ...
    save(strcat('CasesTable_LogReg_SPIRAL_',num2str(length(lambdas_rel)),'lambdas_seed',num2str(rng_seed)),"table_cases_SPIRAL")        
end
