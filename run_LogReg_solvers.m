...
% profile on
% precalc.improving = false; fprintf('CoD solver LogReg + Screening...\n')
precalc.improving = 2; fprintf('CoD solver LogReg + Screening w/ analytical refinement......\n')
...
[x_CoDscr_global, obj_CoDscr_global, x_it_CoDscr_global, R_it_CoDscr_global, screen_it_CoDscr_global, stop_crit_it_CoDscr_global, time_it_CoDscr_global, trace_CoDscr_global] ...
    = LogReg_CoD_l1_GAPSafe(A,y,lambda,x0_CoDscr,param,precalc); 
