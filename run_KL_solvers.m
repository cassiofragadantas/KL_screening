...
precalc.improving = false; fprintf('CoD solver KL...\n')
% profile on    
...
%CoD + Screening
precalc.improving = true; fprintf('CoD solver KL + Screening w/ refinement...\n')
...
if MM
%MM
precalc.improving = false; fprintf('MM solver KL...\n')
[x_MM, obj_MM, x_it_MM, stop_crit_it_MM, time_it_MM] ...
    = KL_l1_MM(A,y,lambda,x0_MM,param);

%MM + Screening
precalc.improving = true; fprintf('MM solver KL + Screening w/ refinement...\n')
